...
import { Accordion, Container, Navbar, NavDropdown } from "react-bootstrap";
...
function AdminLayout({ children }) {
	...
	return (
		<div id="app" className="adminLayout">
			<div id="sidebar">
						...
						<ul className="menu">
							...
							<Accordion defaultActiveKey={["0"]} alwaysOpen>
								...
								>
									...
									<Accordion.Body className="submenu submenu-open">
			...
			<div id="main">
				<Navbar expand="lg" style={{ backgroundColor: "inherit" }}>
				...
				<footer>
					<div className="footer clearfix mx-auto text-muted">
